import { Mail, Globe, Instagram, Linkedin, Briefcase } from "lucide-react";
import logo from "../assets/logo.png";

export function FooterSection() {
    return (
        <footer className="bg-gradient-to-b from-gray-900 via-gray-900 to-[#0a0f1f] text-white py-16">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="text-center text-gray-400 text-sm border-t border-gray-800 pt-6">
                    <p>
                        &copy; 2025 Clipmasters. All rights reserved. |{" "}
